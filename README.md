...
## Introduce
   다양한 스마트 기기, 예를 들어 스마트폰, 태블릿, 컴퓨터, 스마트 TV 등을 통해 손쉽게 접근할 수 있는 응용 분야로,<br/>  
  사용자들이 자주 사용하는 휴대전화의 카메라와 캡처 기능을 활용하여 이미지를 분석하고, <br/>
  이를 통해 사용자가 원하는 의류와 유사성이 높은 제품을 매칭해 손쉽게 찾을 수 있도록 하여 만족감을 극대화하고자 <br/>
  본 프로젝트를 기획하게 되었습니다.
